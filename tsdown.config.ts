/**
 * Standalone tsdown config for the loci-dsh external plugin (adapted from the
 * dsh-sentinel external-plugin config, itself adapted from dsh-focus-chat):
